...
const Pagination: React.FC<Props> = ({prev, next}) => {
    return (
        <IonRow className="ion-align-items-center ion-justify-center-center p-0 mt-1">
            ...
            >
                <IonButton className="pagination-btn m-0" fill='outline' color="success" onClick={prev}>
            ...
            <IonCol
                ...
                className='text-left'
            >
                <IonButton className="pagination-btn m-0" fill='outline' color="success" onClick={next}>
                    Next
